...
if (!class_exists('collapsingCategoryList_AdminPageFramework_Registry', false)):
    abstract class collapsingCategoryList_AdminPageFramework_Registry_Base {
    ...
    final class collapsingCategoryList_AdminPageFramework_Registry extends collapsingCategoryList_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$sAutoLoaderPath = isset(self::$aClassFiles['collapsingCategoryList_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['collapsingCategoryList_AdminPageFramework_RegisterClasses'] : '';
            self::$bIsMinifiedVersion = class_exists('collapsingCategoryList_AdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['collapsingCategoryList_AdminPageFramework_InclusionClassFilesHeader']);
        }
...
if (!class_exists('collapsingCategoryList_AdminPageFramework_Bootstrap', false)):
    final class collapsingCategoryList_AdminPageFramework_Bootstrap {
        static private $_bLoaded = false;
        public function __construct($sLibraryPath) {
            if (!$this->_isLoadable()) {
                return;
            }
            collapsingCategoryList_AdminPageFramework_Registry::setUp($sLibraryPath);
            if (collapsingCategoryList_AdminPageFramework_Registry::$bIsMinifiedVersion) {
                return;
            }
            $this->_include();
        }
        ...
        private function _include() {
            include (collapsingCategoryList_AdminPageFramework_Registry::$sAutoLoaderPath);
            new collapsingCategoryList_AdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('collapsingCategoryList_AdminPageFramework_MinifiedVersionHeader', 'collapsingCategoryList_AdminPageFramework_BeautifiedVersionHeader',),), collapsingCategoryList_AdminPageFramework_Registry::$aClassFiles);
            self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
            if (self::$_bXDebug) {
                new collapsingCategoryList_AdminPageFramework_Utility;
                new collapsingCategoryList_AdminPageFramework_WPUtility;
            }
        }
        static private $_bXDebug;
    }
    new collapsingCategoryList_AdminPageFramework_Bootstrap(__FILE__);
endif;
