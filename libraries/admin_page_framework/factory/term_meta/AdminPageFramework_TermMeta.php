...
abstract class collapsingCategoryList_AdminPageFramework_TermMeta_Router extends collapsingCategoryList_AdminPageFramework_TaxonomyField_Controller {
}
abstract class collapsingCategoryList_AdminPageFramework_TermMeta_Model extends collapsingCategoryList_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new collapsingCategoryList_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class collapsingCategoryList_AdminPageFramework_TermMeta_View extends collapsingCategoryList_AdminPageFramework_TermMeta_Model {
...
abstract class collapsingCategoryList_AdminPageFramework_TermMeta_Controller extends collapsingCategoryList_AdminPageFramework_TermMeta_View {
}
abstract class collapsingCategoryList_AdminPageFramework_TermMeta extends collapsingCategoryList_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'collapsing.category-list') {
