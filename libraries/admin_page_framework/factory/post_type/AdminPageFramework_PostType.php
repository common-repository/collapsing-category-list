...
abstract class collapsingCategoryList_AdminPageFramework_PostType_Router extends collapsingCategoryList_AdminPageFramework_Factory {
...
abstract class collapsingCategoryList_AdminPageFramework_PostType_Model extends collapsingCategoryList_AdminPageFramework_PostType_Router {
    public function __construct($oProp) {
        parent::__construct($oProp);
        ...
        if ($this->oProp->bIsAdmin) {
            ...
            if ($this->oProp->sCallerPath) {
                new collapsingCategoryList_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
            }
        }
    }
    ...
    public function _replyToRegisterPostType() {
        ...
        new collapsingCategoryList_AdminPageFramework_PostType_Model__SubMenuOrder($this);
    }
...
abstract class collapsingCategoryList_AdminPageFramework_PostType_View extends collapsingCategoryList_AdminPageFramework_PostType_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->oProp->bIsAdmin) {
    ...
    public function _replyToPrintStyle() {
        ...
        if (!empty($this->oProp->sStyle)) {
            echo "<style type='text/css' id='collapsing.category-list-style-post-type'>" . $this->oProp->sStyle . "</style>";
        }
    }
...
abstract class collapsingCategoryList_AdminPageFramework_PostType_Controller extends collapsingCategoryList_AdminPageFramework_PostType_View {
...
abstract class collapsingCategoryList_AdminPageFramework_PostType extends collapsingCategoryList_AdminPageFramework_PostType_Controller {
    protected $_sStructureType = 'post_type';
    public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'collapsing.category-list') {
        if (empty($sPostType)) {
            return;
        }
        ...
        $this->oProp->sPostType = collapsingCategoryList_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
        $this->oProp->aPostTypeArgs = $aArguments;
    ...
    private function _getCallerScriptPath($sCallerPath) {
        ...
        $_sPageNow = collapsingCategoryList_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
        if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
            return collapsingCategoryList_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        }
        return null;
    }
}
