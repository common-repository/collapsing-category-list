...
abstract class collapsingCategoryList_AdminPageFramework_PageMetaBox_Router extends collapsingCategoryList_AdminPageFramework_MetaBox_View {
...
abstract class collapsingCategoryList_AdminPageFramework_PageMetaBox_Model extends collapsingCategoryList_AdminPageFramework_PageMetaBox_Router {
...
abstract class collapsingCategoryList_AdminPageFramework_PageMetaBox_View extends collapsingCategoryList_AdminPageFramework_PageMetaBox_Model {
}
abstract class collapsingCategoryList_AdminPageFramework_PageMetaBox_Controller extends collapsingCategoryList_AdminPageFramework_PageMetaBox_View {
...
abstract class collapsingCategoryList_AdminPageFramework_PageMetaBox extends collapsingCategoryList_AdminPageFramework_PageMetaBox_Controller {
    protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'collapsing.category-list') {
