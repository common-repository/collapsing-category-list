...
class collapsingCategoryList_AdminPageFramework_Property_page_meta_box extends collapsingCategoryList_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'collapsing.category-list', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['acollapsingCategoryList_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('acollapsingCategoryList_AdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['acollapsingCategoryList_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('acollapsingCategoryList_AdminPageFramework', 'aPageClasses'));
