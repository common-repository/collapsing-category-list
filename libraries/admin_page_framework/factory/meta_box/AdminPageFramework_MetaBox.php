...
abstract class collapsingCategoryList_AdminPageFramework_MetaBox_Router extends collapsingCategoryList_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'collapsing.category-list') {
...
abstract class collapsingCategoryList_AdminPageFramework_MetaBox_Model extends collapsingCategoryList_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'collapsing.category-list') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new collapsingCategoryList_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class collapsingCategoryList_AdminPageFramework_MetaBox_View extends collapsingCategoryList_AdminPageFramework_MetaBox_Model {
...
abstract class collapsingCategoryList_AdminPageFramework_MetaBox_Controller extends collapsingCategoryList_AdminPageFramework_MetaBox_View {
...
abstract class collapsingCategoryList_AdminPageFramework_MetaBox extends collapsingCategoryList_AdminPageFramework_MetaBox_Controller {
