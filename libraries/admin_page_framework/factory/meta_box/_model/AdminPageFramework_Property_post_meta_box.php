...
class collapsingCategoryList_AdminPageFramework_Property_post_meta_box extends collapsingCategoryList_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'collapsing.category-list', $sStructureType = 'post_meta_box') {
