...
abstract class collapsingCategoryList_AdminPageFramework_TaxonomyField_Router extends collapsingCategoryList_AdminPageFramework_Factory {
...
abstract class collapsingCategoryList_AdminPageFramework_TaxonomyField_Model extends collapsingCategoryList_AdminPageFramework_TaxonomyField_Router {
...
abstract class collapsingCategoryList_AdminPageFramework_TaxonomyField_View extends collapsingCategoryList_AdminPageFramework_TaxonomyField_Model {
...
abstract class collapsingCategoryList_AdminPageFramework_TaxonomyField_Controller extends collapsingCategoryList_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class collapsingCategoryList_AdminPageFramework_TaxonomyField extends collapsingCategoryList_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'collapsing.category-list') {
