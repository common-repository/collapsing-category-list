...
abstract class collapsingCategoryList_AdminPageFramework_CustomSubmitFields extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class collapsingCategoryList_AdminPageFramework_ExportOptions extends collapsingCategoryList_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo collapsingCategoryList_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
