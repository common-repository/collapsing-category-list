...
class collapsingCategoryList_AdminPageFramework_Property_admin_page extends collapsingCategoryList_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'collapsing.category-list') {
        ...
        $GLOBALS['acollapsingCategoryList_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('acollapsingCategoryList_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['acollapsingCategoryList_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
