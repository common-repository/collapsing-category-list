...
class collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator_Base extends collapsingCategoryList_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator extends collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator__Link', 'collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator__Import', 'collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator__Export', 'collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
