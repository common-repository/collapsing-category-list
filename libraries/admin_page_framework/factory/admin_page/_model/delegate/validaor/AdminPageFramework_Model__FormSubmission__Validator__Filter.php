...
class collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator__Filter extends collapsingCategoryList_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
