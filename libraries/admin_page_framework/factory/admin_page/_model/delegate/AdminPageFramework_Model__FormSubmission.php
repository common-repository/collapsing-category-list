...
abstract class collapsingCategoryList_AdminPageFramework_Model__FormSubmission_Base extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
...
class collapsingCategoryList_AdminPageFramework_Model__FormSubmission extends collapsingCategoryList_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new collapsingCategoryList_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new collapsingCategoryList_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
