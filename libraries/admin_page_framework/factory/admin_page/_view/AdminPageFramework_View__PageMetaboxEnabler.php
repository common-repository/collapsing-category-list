...
class collapsingCategoryList_AdminPageFramework_View__PageMetaboxEnabler extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _isMetaBoxAdded() {
        $_aPageMetaBoxClasses = $this->getElementAsArray($GLOBALS, array('acollapsingCategoryList_AdminPageFramework', 'aMetaBoxForPagesClasses'));
    ...
    public function _replyToAddMetaboxScript() {
        $_bLoaded = $this->getElement($GLOBALS, array('acollapsingCategoryList_AdminPageFramework', 'bAddedMetaBoxScript'), false);
        if ($_bLoaded) {
            return;
        }
        $GLOBALS['acollapsingCategoryList_AdminPageFramework']['bAddedMetaBoxScript'] = true;
        $_sScript = <<<JAVASCRIPTS
jQuery( document).ready( function(){ 
    postboxes.add_postbox_toggles( pagenow ); 
});
JAVASCRIPTS;
        echo '<script class="collapsing.category-list-insert-metabox-script">' . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . '</script>';
    }
}
