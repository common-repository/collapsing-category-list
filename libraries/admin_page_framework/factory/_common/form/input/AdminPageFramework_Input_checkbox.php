...
abstract class collapsingCategoryList_AdminPageFramework_Input_Base extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'collapsing.category-list-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'collapsing.category-list-input-label-string',),);
...
class collapsingCategoryList_AdminPageFramework_Input_checkbox extends collapsingCategoryList_AdminPageFramework_Input_Base {
