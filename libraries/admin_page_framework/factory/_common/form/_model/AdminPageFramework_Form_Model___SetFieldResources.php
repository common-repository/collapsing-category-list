...
class collapsingCategoryList_AdminPageFramework_Form_Model___SetFieldResources extends collapsingCategoryList_AdminPageFramework_Form_Base {
    ...
    private function _setCommon() {
        ...
        self::$_bCalled = true;
        new collapsingCategoryList_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->_setCommonFormInternalCSSRules();
    }
    private function _setCommonFormInternalCSSRules() {
        $_aClassNames = array('collapsingCategoryList_AdminPageFramework_Form_View___CSS_Form', 'collapsingCategoryList_AdminPageFramework_Form_View___CSS_Field', 'collapsingCategoryList_AdminPageFramework_Form_View___CSS_Section', 'collapsingCategoryList_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'collapsingCategoryList_AdminPageFramework_Form_View___CSS_FieldError', 'collapsingCategoryList_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('collapsingCategoryList_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function _setFieldResources(array $aFieldset) {
        ...
        new collapsingCategoryList_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new collapsingCategoryList_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
