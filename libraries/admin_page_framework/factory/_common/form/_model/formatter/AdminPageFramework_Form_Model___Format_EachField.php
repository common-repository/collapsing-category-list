...
abstract class collapsingCategoryList_AdminPageFramework_Form_Model___Format_FormField_Base extends collapsingCategoryList_AdminPageFramework_Form_Utility {
}
class collapsingCategoryList_AdminPageFramework_Form_Model___Format_EachField extends collapsingCategoryList_AdminPageFramework_Form_Model___Format_FormField_Base {
    ...
    public function get() {
        ...
        $_oInputTagIDGenerator = new collapsingCategoryList_AdminPageFramework_Form_View___Generate_FieldInputID($_aField, $this->isIndex, $this->aCallbacks['hfID']);
        $_aField['input_id'] = $_oInputTagIDGenerator->get();
        $_oFieldInputNameGenerator = new collapsingCategoryList_AdminPageFramework_Form_View___Generate_FieldInputName($_aField, $this->getAOrB($_aField['_is_multiple_fields'], $this->isIndex, ''), $this->aCallbacks['hfInputName']);
        $_aField['_input_name'] = $_oFieldInputNameGenerator->get();
        $_oFieldFlatInputName = new collapsingCategoryList_AdminPageFramework_Form_View___Generate_FlatFieldInputName($_aField, $this->getAOrB($_aField['_is_multiple_fields'], $this->isIndex, ''), $this->aCallbacks['hfInputNameFlat']);
        ...
        $_aField['_field_object'] = new collapsingCategoryList_AdminPageFramework_ArrayHandler($_aField);
        return $_aField;
    }
}
