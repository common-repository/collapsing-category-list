...
class collapsingCategoryList_AdminPageFramework_Form_Model___Format_RepeatableSection extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : collapsingCategoryList_AdminPageFramework_Message::getInstance();
    }
    public function get() {
...
class collapsingCategoryList_AdminPageFramework_Form_Model___Format_RepeatableField extends collapsingCategoryList_AdminPageFramework_Form_Model___Format_RepeatableSection {
    protected function _getDefaultMessage() {
