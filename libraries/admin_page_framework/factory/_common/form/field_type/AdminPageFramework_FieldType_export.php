...
class collapsingCategoryList_AdminPageFramework_FieldType_submit extends collapsingCategoryList_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".collapsing.category-list-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'collapsing.category-list-input-label-container' . ' collapsing.category-list-input-button-container' . ' collapsing.category-list-input-container',);
    }
...
class collapsingCategoryList_AdminPageFramework_FieldType_export extends collapsingCategoryList_AdminPageFramework_FieldType_submit {
