...
class collapsingCategoryList_AdminPageFramework_FieldType_text extends collapsingCategoryList_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('text', 'password', 'date', 'datetime', 'datetime-local', 'email', 'month', 'search', 'tel', 'url', 'week',);
    protected $aDefaultKeys = array();
    protected function getStyles() {
        return ".collapsing.category-list-field.collapsing.category-list-field-text > .collapsing.category-list-input-label-container {vertical-align: middle; }.collapsing.category-list-field.collapsing.category-list-field-text > .collapsing.category-list-input-label-container.collapsing.category-list-field-text-multiple-labels {display: block;}";
    }
    ...
    private function _getFieldOutputByLabel($sKey, $sLabel, $aField) {
        ...
        $_sClassSelector = $_bIsArray ? 'collapsing.category-list-field-text-multiple-labels' : '';
        ...
        $_aOutput = array($this->getElementByLabel($aField['before_label'], $sKey, $aField['label']), "<div class='collapsing.category-list-input-label-container {$_sClassSelector}'>", "<label for='" . $_aInputAttributes['id'] . "'>", $this->getElementByLabel($aField['before_input'], $sKey, $aField['label']), $_sLabel ? "<span " . $this->getLabelContainerAttributes($aField, 'collapsing.category-list-input-label-string') . ">" . $_sLabel . "</span>" : '', "<input " . $this->getAttributes($_aInputAttributes) . " />", $this->getElementByLabel($aField['after_input'], $sKey, $aField['label']), "</label>", "</div>", $this->getElementByLabel($aField['after_label'], $sKey, $aField['label']),);
        return implode('', $_aOutput);
    }
}
class collapsingCategoryList_AdminPageFramework_FieldType_file extends collapsingCategoryList_AdminPageFramework_FieldType_text {
