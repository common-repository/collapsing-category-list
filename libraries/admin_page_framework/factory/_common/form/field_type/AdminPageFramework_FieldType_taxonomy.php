...
class collapsingCategoryList_AdminPageFramework_FieldType_taxonomy extends collapsingCategoryList_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new collapsingCategoryList_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enablecollapsingCategoryList_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enablecollapsingCategoryList_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registercollapsingCategoryList_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Initialize
            enablecollapsingCategoryList_AdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".collapsing.category-list-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.collapsing.category-list-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.collapsing.category-list-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.collapsing.category-list-field .taxonomy-checklist ul ul {margin-left: 1em;}.collapsing.category-list-field .taxonomy-checklist-label {white-space: nowrap; }.collapsing.category-list-field .tab-box-container.categorydiv {max-height: none;}.collapsing.category-list-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.collapsing.category-list-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.collapsing.category-list-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.collapsing.category-list-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.collapsing.category-list-field .tab-box-tabs li a { color: #333; text-decoration: none; }.collapsing.category-list-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.collapsing.category-list-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.collapsing.category-list-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.collapsing.category-list-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.collapsing.category-list-field .tab-box-content:target, .collapsing.category-list-field .tab-box-content:target, .collapsing.category-list-field .tab-box-content:target { display: block; }.collapsing.category-list-field .tab-box-content .select_all_button_container, .collapsing.category-list-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.collapsing.category-list-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
