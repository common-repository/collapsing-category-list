...
class collapsingCategoryList_AdminPageFramework_FieldType_checkbox extends collapsingCategoryList_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '{$_sClassSelectorSelectAll}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllcollapsingCategoryList_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '{$_sClassSelectorSelectNone}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllcollapsingCategoryList_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
});
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.collapsing.category-list-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.collapsing.category-list-checkbox-label {margin-top: 0.1em;}.collapsing.category-list-field input[type='checkbox' ] {margin-right: 0.5em;} .collapsing.category-list-field-checkbox .collapsing.category-list-input-label-container {padding-right: 1em;}.collapsing.category-list-field-checkbox .collapsing.category-list-input-label-string{display: inline; }";
    }
...
class collapsingCategoryList_AdminPageFramework_FieldType_posttype extends collapsingCategoryList_AdminPageFramework_FieldType_checkbox {
    ...
    protected function getStyles() {
        ...
        return $_sParentStyles . ".collapsing.category-list-field input[type='checkbox'] {margin-right: 0.5em;} .collapsing.category-list-field-posttype .collapsing.category-list-input-label-container {padding-right: 1em;}";
    }
    protected function getField($aField) {
