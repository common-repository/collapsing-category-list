...
class collapsingCategoryList_AdminPageFramework_FieldType_import extends collapsingCategoryList_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".collapsing.category-list-field-import input {margin-right: 0.5em;}.collapsing.category-list-field-import label,.form-table td fieldset.collapsing.category-list-fieldset .collapsing.category-list-field-import label { display: inline; }";
    }
