...
class collapsingCategoryList_AdminPageFramework_FieldType_radio extends collapsingCategoryList_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".collapsing.category-list-field input[type='radio'] {margin-right: 0.5em;} .collapsing.category-list-field-radio .collapsing.category-list-input-label-container {padding-right: 1em;} .collapsing.category-list-field-radio .collapsing.category-list-input-container {display: inline;} .collapsing.category-list-field-radio .collapsing.category-list-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.collapsing.category-list-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
