...
class collapsingCategoryList_AdminPageFramework_Form___SubmitNotice extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new collapsingCategoryList_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new collapsingCategoryList_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}
