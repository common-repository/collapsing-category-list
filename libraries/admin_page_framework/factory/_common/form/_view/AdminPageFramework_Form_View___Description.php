...
class collapsingCategoryList_AdminPageFramework_Form_View___Description extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'collapsing.category-list-form-element-description';
