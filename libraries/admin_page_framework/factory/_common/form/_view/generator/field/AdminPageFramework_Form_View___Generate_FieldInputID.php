...
class collapsingCategoryList_AdminPageFramework_Form_View___Generate_FieldTagID extends collapsingCategoryList_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class collapsingCategoryList_AdminPageFramework_Form_View___Generate_FieldInputID extends collapsingCategoryList_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
