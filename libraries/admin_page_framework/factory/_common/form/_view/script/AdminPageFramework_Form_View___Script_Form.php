...
class collapsingCategoryList_AdminPageFramework_Form_View___Script_Form extends collapsingCategoryList_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removecollapsingCategoryList_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.collapsing.category-list-form-loading' ).remove();
        jQuery( '.collapsing.category-list-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.collapsing.category-list-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removecollapsingCategoryList_AdminPageFrameworkLoadingOutputs();
