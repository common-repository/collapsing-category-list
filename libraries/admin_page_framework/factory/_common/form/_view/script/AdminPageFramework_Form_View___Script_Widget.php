...
class collapsingCategoryList_AdminPageFramework_Form_View___Script_Widget extends collapsingCategoryList_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.collapsing.category-list-sectionset' ).length <= 0 ) { 
                    return; 
                }   
                ...
                $( document ).trigger( 
                    'collapsing.category-list_saved_widget', 
                    _oWidget 
                );
