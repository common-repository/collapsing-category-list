...
class collapsingCategoryList_AdminPageFramework_Form_View___Script_SectionTab extends collapsingCategoryList_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.collapsing.category-list-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='collapsing.category-list-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
