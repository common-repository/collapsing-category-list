...
abstract class collapsingCategoryList_AdminPageFramework_Form_View___Attribute_Base extends collapsingCategoryList_AdminPageFramework_Form_Utility {
    public $sContext = '';
...
abstract class collapsingCategoryList_AdminPageFramework_Form_View___Attribute_FieldContainer_Base extends collapsingCategoryList_AdminPageFramework_Form_View___Attribute_Base {
    protected function _getFormattedAttributes() {
...
class collapsingCategoryList_AdminPageFramework_Form_View___Attribute_Field extends collapsingCategoryList_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    public $sContext = 'field';
    protected function _getAttributes() {
        $_sFieldTypeSelector = $this->getAOrB($this->aArguments['type'], " collapsing.category-list-field-{$this->aArguments['type']}", '');
        ...
        return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "collapsing.category-list-field{$_sFieldTypeSelector}{$_sNestedFieldSelector}{$_sMixedFieldSelector}{$_sChildFieldSelector}" . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' collapsing.category-list-subfield', ''));
    }
}
