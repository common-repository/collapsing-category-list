...
class collapsingCategoryList_AdminPageFramework_Form_View___Attribute_SectionsTablesContainer extends collapsingCategoryList_AdminPageFramework_Form_View___Attribute_Base {
    ...
    protected function _getAttributes() {
        return array('id' => $this->sSectionsID, 'class' => $this->getClassAttribute('collapsing.category-list-sections', $this->getAOrB(!$this->sSectionTabSlug || '_default' === $this->sSectionTabSlug, null, 'collapsing.category-list-section-tabs-contents'), $this->getAOrB(empty($this->aCollapsible), null, 'collapsing.category-list-collapsible-sections-content' . ' ' . 'collapsing.category-list-collapsible-content' . ' ' . 'accordion-section-content'), $this->getAOrB(empty($this->aSectionset['sortable']), null, 'sortable-section')), 'data-seciton_id' => $this->aSectionset['section_id'], 'data-section_address' => $this->aSectionset['section_id'], 'data-section_address_model' => $this->aSectionset['section_id'] . '|' . '___i___',) + $this->_getDynamicElementArguments($this->aSectionset);
    }
    private function _getDynamicElementArguments($aSectionset) {
        ...
        $_oSectionNameGenerator = new collapsingCategoryList_AdminPageFramework_Form_View___Generate_SectionName($aSectionset, $aSectionset['_caller_object']->aCallbacks['hfSectionName']);
