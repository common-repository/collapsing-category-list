...
class collapsingCategoryList_AdminPageFramework_Form_View___DebugInfo extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='collapsing.category-list-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
