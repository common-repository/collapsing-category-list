...
class collapsingCategoryList_AdminPageFramework_FrameworkUtility extends collapsingCategoryList_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = collapsingCategoryList_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return collapsingCategoryList_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
}
class collapsingCategoryList_AdminPageFramework_ArrayHandler extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    public $aData = array();
