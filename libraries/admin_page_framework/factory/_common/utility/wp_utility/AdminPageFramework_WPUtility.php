...
class collapsingCategoryList_AdminPageFramework_WPUtility_URL extends collapsingCategoryList_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(collapsingCategoryList_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(collapsingCategoryList_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = collapsingCategoryList_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class collapsingCategoryList_AdminPageFramework_WPUtility_HTML extends collapsingCategoryList_AdminPageFramework_WPUtility_URL {
...
class collapsingCategoryList_AdminPageFramework_WPUtility_Page extends collapsingCategoryList_AdminPageFramework_WPUtility_HTML {
...
class collapsingCategoryList_AdminPageFramework_WPUtility_Hook extends collapsingCategoryList_AdminPageFramework_WPUtility_Page {
...
class collapsingCategoryList_AdminPageFramework_WPUtility_File extends collapsingCategoryList_AdminPageFramework_WPUtility_Hook {
...
class collapsingCategoryList_AdminPageFramework_WPUtility_Option extends collapsingCategoryList_AdminPageFramework_WPUtility_File {
...
class collapsingCategoryList_AdminPageFramework_WPUtility_Meta extends collapsingCategoryList_AdminPageFramework_WPUtility_Option {
...
class collapsingCategoryList_AdminPageFramework_WPUtility_SiteInformation extends collapsingCategoryList_AdminPageFramework_WPUtility_Meta {
...
class collapsingCategoryList_AdminPageFramework_WPUtility_SystemInformation extends collapsingCategoryList_AdminPageFramework_WPUtility_SiteInformation {
...
class collapsingCategoryList_AdminPageFramework_WPUtility extends collapsingCategoryList_AdminPageFramework_WPUtility_SystemInformation {
