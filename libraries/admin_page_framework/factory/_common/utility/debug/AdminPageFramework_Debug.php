...
class collapsingCategoryList_AdminPageFramework_Debug_Base extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
...
class collapsingCategoryList_AdminPageFramework_Debug_Log extends collapsingCategoryList_AdminPageFramework_Debug_Base {
...
class collapsingCategoryList_AdminPageFramework_Debug extends collapsingCategoryList_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('collapsingCategoryList_AdminPageFramework_Debug::' . __FUNCTION__, 'collapsingCategoryList_AdminPageFramework_Debug::dump()');
        collapsingCategoryList_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('collapsingCategoryList_AdminPageFramework_Debug::' . __FUNCTION__, 'collapsingCategoryList_AdminPageFramework_Debug::get()');
        return collapsingCategoryList_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('collapsingCategoryList_AdminPageFramework_Debug::' . __FUNCTION__, 'collapsingCategoryList_AdminPageFramework_Debug::log()');
        collapsingCategoryList_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('collapsingCategoryList_AdminPageFramework_Debug::' . __FUNCTION__);
