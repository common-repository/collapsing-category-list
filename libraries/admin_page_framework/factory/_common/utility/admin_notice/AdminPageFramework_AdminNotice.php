...
class collapsingCategoryList_AdminPageFramework_AdminNotice extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'collapsing.category-list-settings-notice-message', 'collapsing.category-list-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new collapsingCategoryList_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
