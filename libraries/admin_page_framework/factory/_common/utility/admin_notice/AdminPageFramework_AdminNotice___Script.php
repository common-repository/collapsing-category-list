...
class collapsingCategoryList_AdminPageFramework_AdminNotice___Script extends collapsingCategoryList_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.collapsing.category-list-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='collapsing.category-list-admin-notice-animation-container'></div>" );
