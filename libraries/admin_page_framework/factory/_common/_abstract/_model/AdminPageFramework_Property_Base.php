...
abstract class collapsingCategoryList_AdminPageFramework_Property_Base extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'collapsing.category-list' : $sTextDomain;
    ...
    private function _setGlobals() {
        if (!isset($GLOBALS['acollapsingCategoryList_AdminPageFramework'])) {
            $GLOBALS['acollapsingCategoryList_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => collapsingCategoryList_AdminPageFramework_Registry::NAME, 'sURI' => collapsingCategoryList_AdminPageFramework_Registry::URI, 'sScriptName' => collapsingCategoryList_AdminPageFramework_Registry::NAME, 'sLibraryName' => collapsingCategoryList_AdminPageFramework_Registry::NAME, 'sLibraryURI' => collapsingCategoryList_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => collapsingCategoryList_AdminPageFramework_Registry::getVersion(), 'sDescription' => collapsingCategoryList_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => collapsingCategoryList_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => collapsingCategoryList_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => collapsingCategoryList_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => collapsingCategoryList_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new collapsingCategoryList_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
