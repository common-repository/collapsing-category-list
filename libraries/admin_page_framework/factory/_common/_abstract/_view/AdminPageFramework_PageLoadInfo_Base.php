...
abstract class collapsingCategoryList_AdminPageFramework_PageLoadInfo_Base extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    public $oProp;
    public $oMsg;
    ...
    private function _getPageLoadStats() {
        ...
        return "<div id='collapsing.category-list-page-load-stats'>" . "<ul>" . "<li>" . sprintf($this->oMsg->get('queries_in_seconds'), $_nQueryCount, $_nSeconds) . "</li>" . "<li>" . sprintf($this->oMsg->get('out_of_x_memory_used'), $_nMemoryUsage, $_nMemoryLimit, round(($_nMemoryUsage / $_nMemoryLimit), 2) * 100 . '%') . "</li>" . "<li>" . sprintf($this->oMsg->get('peak_memory_usage'), $_nMemoryPeakUsage) . "</li>" . "<li>" . sprintf($this->oMsg->get('initial_memory_usage'), $_sInitialMemoryUsage) . "</li>" . "</ul>" . "</div>";
    }
