...
abstract class collapsingCategoryList_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'collapsingCategoryList_AdminPageFramework_Form_', 'oPageLoadInfo' => 'collapsingCategoryList_AdminPageFramework_PageLoadInfo_', 'oResource' => 'collapsingCategoryList_AdminPageFramework_Resource_', 'oHelpPane' => 'collapsingCategoryList_AdminPageFramework_HelpPane_', 'oLink' => 'collapsingCategoryList_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'collapsingCategoryList_AdminPageFramework_Debug', 'oUtil' => 'collapsingCategoryList_AdminPageFramework_FrameworkUtility', 'oMsg' => 'collapsingCategoryList_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(collapsingCategoryList_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return collapsingCategoryList_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class collapsingCategoryList_AdminPageFramework_Factory_Model extends collapsingCategoryList_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class collapsingCategoryList_AdminPageFramework_Factory_View extends collapsingCategoryList_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new collapsingCategoryList_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class collapsingCategoryList_AdminPageFramework_Factory_Controller extends collapsingCategoryList_AdminPageFramework_Factory_View {
...
abstract class collapsingCategoryList_AdminPageFramework_Factory extends collapsingCategoryList_AdminPageFramework_Factory_Controller {
}
