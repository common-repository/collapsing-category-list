...
class collapsingCategoryList_AdminPageFramework_PageLoadInfo_network_admin_page extends collapsingCategoryList_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new collapsingCategoryList_AdminPageFramework_PageLoadInfo_network_admin_page($oProp, $oMsg);
        return self::$_oInstance;
    }
