...
class collapsingCategoryList_AdminPageFramework_Property_widget extends collapsingCategoryList_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'collapsing.category-list', $sStructureType) {
