...
abstract class collapsingCategoryList_AdminPageFramework_Widget_Router extends collapsingCategoryList_AdminPageFramework_Factory {
...
abstract class collapsingCategoryList_AdminPageFramework_Widget_Model extends collapsingCategoryList_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new collapsingCategoryList_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class collapsingCategoryList_AdminPageFramework_Widget_View extends collapsingCategoryList_AdminPageFramework_Widget_Model {
...
abstract class collapsingCategoryList_AdminPageFramework_Widget_Controller extends collapsingCategoryList_AdminPageFramework_Widget_View {
...
abstract class collapsingCategoryList_AdminPageFramework_Widget extends collapsingCategoryList_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'collapsing.category-list') {
