...
abstract class collapsingCategoryList_AdminPageFramework_UserMeta_Router extends collapsingCategoryList_AdminPageFramework_Factory {
...
abstract class collapsingCategoryList_AdminPageFramework_UserMeta_Model extends collapsingCategoryList_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new collapsingCategoryList_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class collapsingCategoryList_AdminPageFramework_UserMeta_View extends collapsingCategoryList_AdminPageFramework_UserMeta_Model {
...
abstract class collapsingCategoryList_AdminPageFramework_UserMeta_Controller extends collapsingCategoryList_AdminPageFramework_UserMeta_View {
...
abstract class collapsingCategoryList_AdminPageFramework_UserMeta extends collapsingCategoryList_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'collapsing.category-list') {
