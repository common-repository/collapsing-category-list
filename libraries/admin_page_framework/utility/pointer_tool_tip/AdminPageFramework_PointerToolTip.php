...
class collapsingCategoryList_AdminPageFramework_PointerToolTip extends collapsingCategoryList_AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertInternalScript() {
        echo "<script type='text/javascript' class='collapsing.category-list-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->_getInternalScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
