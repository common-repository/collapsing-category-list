...
abstract class collapsingCategoryList_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('collapsingCategoryList_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new collapsingCategoryList_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
